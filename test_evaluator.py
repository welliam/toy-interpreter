...
def fresh_env():
    ...
    from evaluator import make_env
    return make_env()
...
def test_env(fresh_env):
    ...
    from evaluator import env_extend
...
def primitive_min():
    ...
    from evaluator import primitive_function
...
def identity(fresh_env):
    ...
    from evaluator import compound_function
...
def test_evaluate_compound(identity, fresh_env):
    ...
    from evaluator import evaluate_compound
...
def test_evaluate_lambda(fresh_env):
    ...
    from evaluator import evaluate_lambda, evaluate
...
def test_evaluate_begin(fresh_env):
    ...
    from evaluator import evaluate_begin
...
def test_evaluate_definition(fresh_env):
    ...
    from evaluator import evaluate_definition, env_lookup
...
def test_evaluate_if_true(fresh_env):
    ...
    from evaluator import evaluate_if
...
def test_set_sets_var():
    ...
    from evaluator import make_env, evaluate_set, env_lookup
    env = make_env({'a': 0})
